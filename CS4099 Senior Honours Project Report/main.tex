...
% Defences: adding random pixel noise whenever pixels are extracted
...
\begin{enumerate}
    ...
    \item Install an anti-tracking extension. There are numerous extensions available within this market all which offer a very similar functionality. Both PrivacyBadger \footnote{\url{https://www.eff.org/privacybadger}} and Ghostery \footnote{\url{https://www.ghostery.com/}} employ functionality to limit the effectiveness of third-party tracking. Whilst both extensions have similar performance it is there business models that differ. 
\end{enumerate}
