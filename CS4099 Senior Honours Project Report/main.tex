...
\begin{figure} [H]
    ...
    \end{axis}
    \end{tikzpicture}
    \caption{Results and forecasts of global online advertising spending \parencite{Statistia}.}
\end{figure}
...
An illustration of web beacon interaction can be seen in Figure \ref{fig:web_beacons}. The diagrams shows a user who visits www.example.com denoted by step 1 in the diagram. As shown in Step 2 within the webpage there is a web beacon for  www.tracker.com, therefore the user's browser requests and successfully downloads this image from the web server of www.tracker.com. Thus, the user has unwittingly accessed the domain of tracker.com, illustarted in step 3, and subsequently facilitated this organisation to begin to tracking him/her, as the information noted above is leaked to that web server. 
...
In this section of the report I will discuss numerous simple and free methods to effectively protect your privacy. A detailed explanation of how to utilise these techniques will be given in Appendix B in Section \ref{appendixA}. 
